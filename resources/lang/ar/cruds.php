...
return [
    ...
    'payment' => [
        ...
        'fields'         => [
            ...
            'last_4_digits'             => 'أخر 4 أرقام من الحساب',
            'last_4_digits_helper'      => ' ',
            'amount'             => 'المبلغ',
            'amount_helper'      => ' ',
            'package'             => 'أختر الباقة',
            'package_helper'      => ' ',
            'created_by'             => 'تمت الأضافة عن طريق',
            'created_by_helper'      => ' ',
    ...
    'centerServicesPackage' => [
        ...
        'fields'         => [
            ...
            'attend_type_helper'     => ' ',
            'doctor_type'            => 'نوع الباقة',
            'doctor_type_helper'     => ' ',
            'sessions'               => 'عدد الجلسات',
            'sessions_helper'        => ' ',
            'free_sessions'          => 'الجلسات المجانية',
            'free_sessions_helper'   => ' ',
            'sessions_left'               => 'عدد الجلسات المتبقية',
            'sessions_left_helper'        => ' ',
        ],
    ],
    'allowance' => [
        'title'          => 'البدلات',
