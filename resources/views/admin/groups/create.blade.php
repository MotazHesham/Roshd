    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.groups.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('course_hours') ? 'is-invalid' : '' }}" type="number" name="course_hours" id="course_hours" value="{{ old('course_hours', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('course_cost') ? 'is-invalid' : '' }}" type="number" name="course_cost" id="course_cost" value="{{ old('course_cost', '') }}" step="1" required>
