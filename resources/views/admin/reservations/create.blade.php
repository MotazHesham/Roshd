    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reservations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('delay_date') ? 'is-invalid' : '' }}" type="text" name="delay_date" id="delay_date" value="{{ old('delay_date') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('condation') ? 'is-invalid' : '' }}" name="condation" id="condation">{{ old('condation') }}</textarea>
