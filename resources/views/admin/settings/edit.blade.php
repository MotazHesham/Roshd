    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('you_tube') ? 'is-invalid' : '' }}" type="text" name="you_tube" id="you_tube" value="{{ old('you_tube', $setting->you_tube) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('about_rosd') ? 'is-invalid' : '' }}" name="about_rosd" id="about_rosd" required>{{ old('about_rosd', $setting->about_rosd) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('familly_advice') ? 'is-invalid' : '' }}" name="familly_advice" id="familly_advice" required>{{ old('familly_advice', $setting->familly_advice) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('individual_advice') ? 'is-invalid' : '' }}" name="individual_advice" id="individual_advice" required>{{ old('individual_advice', $setting->individual_advice) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('el_gadaly_elsloky') ? 'is-invalid' : '' }}" name="el_gadaly_elsloky" id="el_gadaly_elsloky" required>{{ old('el_gadaly_elsloky', $setting->el_gadaly_elsloky) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('el_maarefe_elsloky') ? 'is-invalid' : '' }}" name="el_maarefe_elsloky" id="el_maarefe_elsloky" required>{{ old('el_maarefe_elsloky', $setting->el_maarefe_elsloky) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('art_therapy') ? 'is-invalid' : '' }}" name="art_therapy" id="art_therapy" required>{{ old('art_therapy', $setting->art_therapy) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('play_therapy') ? 'is-invalid' : '' }}" name="play_therapy" id="play_therapy" required>{{ old('play_therapy', $setting->play_therapy) }}</textarea>
