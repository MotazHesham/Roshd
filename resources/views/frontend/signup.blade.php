...
@section('content')
    <div class="row signup-wrap">
        <div class="col-lg-4 sign-right">
            <a href="{{ route('frontend.home') }}"><img class="logo-sign"
                    src="{{ asset('frontend/new/img/logo.png') }}"></a>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <form class="signup-form" action="{{ route('frontend.signup_user') }}" method="POST">
                                ...
                                <div class="signup-radio">
                                    <label class="radio-search">
                                        ...
                                        <input type="radio" checked="checked" name="user_type" value="patient"
                                            @if (old('user_type') == 'patient') checked @endif>
                                ...
                                <button type="submit"
                                    class="btn btn-default form-submit-btn shadow-none blue-btn">حفظ</button>
                                <p class="signup-p">
                                    هل لديك حساب من قبل؟
