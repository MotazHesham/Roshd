...
<div class="edit-email-div">
    ...
    <p>تعديل البريد الالكتروني</p>
        ...
        <div class="form-group form-group-edit">
                        <input type="email" placeholder="البريد الالكتروني" required name="email" value="{{Auth::user()->email }}">
     </div>   
        <button type="submit" class="btn btn-default form-submit-btn blue-btn save-edit-btn">حفظ</button></form>
    </div>
</div>  
...
<div class="edit-psw-div">
    ...
    <form action="{{route('frontend.account.update') }}" method="Post">
        ...
        <button type="submit" class="btn btn-default form-submit-btn blue-btn save-edit-btn save-edit-btn">حفظ</button></form>
    </div>
</div> 
<div class="edit-info-div">
    ...
    <form action="{{route('frontend.account.update') }}" method="Post">
        @csrf
        <div class="form-group form-group-edit">
            <input class="edit-name-input" type="text" placeholder="الاسم" required  name="name" value="{{Auth::user()->name }}">
